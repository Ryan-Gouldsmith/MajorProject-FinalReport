...
Editing a note is very much the same except the data is sent via an HTTP post to \texttt{/edit\_meta\_data/:id} where the ID is the note's ID which is currently being edited.
